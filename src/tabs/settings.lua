...
GUI.MakeTab("Settings", "⚙️", page)

GUI.MakeSection(page, "GAME")

GUI.MakeAction(page, "Rejoin", "Rejoin the current server", Theme.Danger, function()
    TeleportService:Teleport(game.PlaceId, player)
end)

GUI.MakeAction(page, "Re-execute hub", "Destroys and reloads the hub", Theme.Info, function()
...
GUI.MakeAction(page, "Stop all", "Disables every active toggle", Color3.fromRGB(251, 146, 60), function()
...
infoCard.Size             = UDim2.new(0, 276, 0, 50)
